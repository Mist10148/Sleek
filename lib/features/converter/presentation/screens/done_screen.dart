...
class DoneScreen extends ConsumerWidget {
  const DoneScreen({super.key, required this.binding, required this.palette, required this.state});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Center(child: DoneSeal(binding: b, palette: p)),
          const SizedBox(height: 22),
          Text('Transcribed.',
              textAlign: TextAlign.center,
              style: b.display0(TextStyle(
                  fontSize: 27, letterSpacing: 1, color: p.display))),
          ...
          MssGhostButton(
            ...
            palette: p,
            leading: MssIcon('open', size: 16, color: p.ghostLabel),
